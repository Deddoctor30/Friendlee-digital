...
var range = function range() {
  var mySliders = document.querySelectorAll(".inputs__slider");
  window.addEventListener('load', function () {
    mySliders.forEach(function (item) {
      (0,_services_rangeParams__WEBPACK_IMPORTED_MODULE_3__.params)(item);
    });
  });
  mySliders.forEach(function (item) {
...
/***/ "./src/js/services/inputValidation.js":
/*!********************************************!*\
  !*** ./src/js/services/inputValidation.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var inputValidation = function inputValidation(value, position, minValue, maxValue) {
  var isNumber = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  if (document.querySelector('.valudation')) {
    document.querySelector('.valudation').remove();
  }
  ...
  if (isNumber) {
    if (isNaN(+value.replace(/ /g, '').replace('₽', ''))) {
      ...
      _validError2.style.cssText = "\n         position: absolute;\n         top: 125px;\n         left: 50px;\n         margin: 0px 0px 2px 14px;\n         color: red;\n         ";
      position.before(_validError2);
    }
  }
};
